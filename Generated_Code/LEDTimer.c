...
} LEDTimer_TDeviceData;

typedef LEDTimer_TDeviceData *LEDTimer_TDeviceDataPtr; /* Pointer to the device data structure. */

/* {Default RTOS Adapter} Static object used for simulation of dynamic driver memory allocation */
static LEDTimer_TDeviceData DeviceDataPrv__DEFAULT_RTOS_ALLOC;
...
LDD_TDeviceData* LEDTimer_Init(LDD_TUserData *UserDataPtr)
{
  ...
  LEDTimer_TDeviceData *DeviceDataPrv;
  ...
  PE_LDD_RegisterDeviceStructure(PE_LDD_COMPONENT_LEDTimer_ID,DeviceDataPrv);
...
{
  LEDTimer_TDeviceData *DeviceDataPrv = PE_LDD_DeviceDataList[PE_LDD_COMPONENT_LEDTimer_ID];

  (void)UserDataPtr;                   /* Parameter is not used, suppress unused argument warning */
  LEDTimer_OnInterrupt(DeviceDataPrv->UserDataPtr); /* Invoke OnInterrupt event */
}
